...
def discover(session, query):
    ...
    # Search endpoints first; if Deloox resolves the query to a dedicated
    # category page, that page contains exactly the products we need.
    seen_pages = set()
    candidates = {}
    for endpoint in endpoints:
        ...
        if len(candidates) >= 2:
            # For an exact query such as Liquid Brun this is enough and avoids
            # touching unrelated catalog pages.
            break
