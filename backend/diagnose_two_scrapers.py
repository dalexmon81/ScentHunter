...
def search(query):
    ...
    for search_query in queries:
        # La ricerca legacy con `search_query` è quella che, dalla diagnostica,
        # restituisce il dataLayer completo dei prodotti. La mettiamo prima.
        # La ricerca corrente può invece superare il timeout breve dello scraper.
        urls.extend([
    ...
    try:
        for url in urls:
            try:
                r = _get(s, url, timeout=SEARCH_TIMEOUT)
