...
LINE_FAMILY_PLANS = {
    "9 pm": {
        "brand": "afnan",
        "terms": ["9 PM", "9PM Elixir", "9PM Night Out", "9PM Rebel", "9 PM Pour Femme"],
    },
    "9 am": {
        "brand": "afnan",
        "terms": ["9 AM", "9 AM Dive", "9 AM Pour Femme"],
    },
    "le beau": {
        "brand": "jean paul gaultier",
        "terms": ["Le Beau", "Le Beau Le Parfum", "Le Beau Paradise Garden"],
    },
}
