...
# Famiglie di profumi molto comuni cercate senza il marchio.
# Servono solo per evitare di mandare query chiaramente designer/niche
# ai tre store Arabic-only.
DESIGNER_NICHE_FAMILIES = {
    "born in roma",
    "le beau",
    "la vie est belle",
    "sauvage",
...
def classify_query_brand(query: str) -> str:
    ...
    for family in DESIGNER_NICHE_FAMILIES:
        if norm(family) in q:
            return "DESIGNER_NICHE"
